              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                    <p className="text-[9px] font-black text-blue-400 uppercase mb-2">Why this is happening</p>
                    <p className="text-xs font-medium text-slate-300">{current.reasoning}</p>
                  </div>

                  <div className="p-4 bg-white/5 rounded-xl border border-white/5">
                    <p className="text-[9px] font-black text-purple-400 uppercase mb-2">What happens next</p>
